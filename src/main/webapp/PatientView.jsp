...
<table class="table table-striped">
 	...
 	<th class="table-dark">Ward Number</th>
 	...
 	<c:forEach var="pat" items="${patientDetails}">
		...
		<tr>
	 	...
	 	<c:url value= "PatientUpdate.jsp" var="pUpdate"> 
	 	...
	 	<td class="table-secondary"> <a href="${pUpdate}"> <button class="btn btn-success" name="update">  Update  </button> </a>  </td>
